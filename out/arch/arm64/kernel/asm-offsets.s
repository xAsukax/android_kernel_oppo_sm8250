...
main:                                   // @main
.Lfunc_begin0:
	.file	1 "/home/dwu/findx/android_kernel_oppo_sm8250-oppo-sm8250_t_13.0.0_1220/out/../arch/arm64/kernel/asm-offsets.c"
...
.ascii "->THREAD_CPU_CONTEXT 3504 offsetof(struct task_struct, thread.cpu_context)"
	//NO_APP
...
.ascii "->TRAMP_VALIAS -279198056448 TRAMP_VALIAS"
	//NO_APP
	.loc	1 186 3                         // ../arch/arm64/kernel/asm-offsets.c:186:3
	//APP
	
.ascii "->PROOT_TSK_CRED 2016 offsetof(struct task_struct, cred)"
	//NO_APP
	.loc	1 187 3                         // ../arch/arm64/kernel/asm-offsets.c:187:3
	//APP
	
.ascii "->PROOT_CRED_UID 4 offsetof(struct cred, uid)"
	//NO_APP
	.loc	1 188 3                         // ../arch/arm64/kernel/asm-offsets.c:188:3
	//APP
	
.ascii "->PROOT_CRED_EUID 20 offsetof(struct cred, euid)"
	//NO_APP
	.loc	1 189 3                         // ../arch/arm64/kernel/asm-offsets.c:189:3
	//APP
	
.ascii "->PROOT_CRED_FSUID 28 offsetof(struct cred, fsuid)"
	//NO_APP
	.loc	1 191 3                         // ../arch/arm64/kernel/asm-offsets.c:191:3
	//APP
	
.ascii "->PROOT_THREAD_ADDR_LIMIT 64 offsetof(struct task_struct, thread_info.addr_limit)"
	//NO_APP
	.loc	1 202 3                         // ../arch/arm64/kernel/asm-offsets.c:202:3
	mov	w0, wzr
	ret
.Ltmp0:
.Lfunc_end0:
...
.Linfo_string0:
	.asciz	"ZyC clang version 12.0.1 (https://github.com/llvm/llvm-project fed41342a82f5a3a9201819a82bf7a48313e296b)" // string offset=0
.Linfo_string1:
	.asciz	"../arch/arm64/kernel/asm-offsets.c" // string offset=105
.Linfo_string2:
	.asciz	"/home/dwu/findx/android_kernel_oppo_sm8250-oppo-sm8250_t_13.0.0_1220/out" // string offset=140
.Linfo_string3:
	.asciz	"main"                          // string offset=213
.Linfo_string4:
	.asciz	"int"                           // string offset=218
	.ident	"ZyC clang version 12.0.1 (https://github.com/llvm/llvm-project fed41342a82f5a3a9201819a82bf7a48313e296b)"
